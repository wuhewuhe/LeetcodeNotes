...
/**
 * @author mac Given two non-negative integers num1 and num2 represented as
 ...
 *         only digits 0-9. Both num1 and num2 do not contain any leading zero,
 *         except the number 0 itself. You must not use any built-in BigInteger
