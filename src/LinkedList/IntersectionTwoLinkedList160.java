...
/**
 * @author mac Write a program to find the node at which the intersection of two
 ...
 * 
 * 
 *         Input: intersectVal = 2, listA = [0,9,1,2,4], listB = [3,2,4], skipA
 *         = 3, skipB = 1 Output: Reference of the node with value = 2 Input
 ...
 *         [0,9,1,2,4]. From the head of B, it reads as [3,2,4]. There are 3
 ...
 *         linked structure. Your code should preferably run in O(n) time and
 *         use only O(1) memory.
 */
public class IntersectionTwoLinkedList160 {
