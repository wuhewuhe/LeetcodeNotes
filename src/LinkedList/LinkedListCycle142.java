 ...
 *         Example 1:
 * 
 *         Input: head = [3,2,0,-4], pos = 1 Output: tail connects to node index
 *         1 Explanation: There is a cycle in the linked list, where tail
 ...
 *         Example 3:
 * 
 *         Input: head = [1], pos = -1 Output: no cycle Explanation: There is no
