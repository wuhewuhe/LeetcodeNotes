...
/**
 * @author mac A bus has n stops numbered from 0 to n - 1 that form a circle. We
 *         know the distance between all pairs of neighboring stops where
 *         distance[i] is the distance between the stops number i and (i + 1) %
 *         n.
 * 
 ...
 *         Constraints:
 * 
 *         1 <= n <= 10^4 distance.length == n 0 <= start, destination < n 0 <=
 *         distance[i] <= 10^4
 */
public class DistanceBetweenTwoBus1184 {
